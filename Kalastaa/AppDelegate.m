...
-(void)SetupTabbarController
{
    ...
    DashboardViewController *DemoViewController = [[DashboardViewController alloc] init];
    ...
    [DemoViewController setTabBarItem: tabBarItem];
    [viewControllers addObject:DemoViewController];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.Kalastaa.Kalastaa" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Kalastaa" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Kalastaa.sqlite"];
    NSError *error = nil;
